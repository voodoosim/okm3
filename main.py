...
from config import BOT_TOKEN, logger, LOG_CHANNEL_ID, PUBLIC_LOG_CHANNEL_ID
from handlers import admin, ban, kick, unban, group, bot_events, mute  # mute 추가
...
async def main():
    ...
    dp.include_router(mute.router)  # 추가
